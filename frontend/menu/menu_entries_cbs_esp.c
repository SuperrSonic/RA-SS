...
static const char reso_pant[23] = { 0x52, 0x65, 0x73, 0x6F, 0x6C, 0x75, 0x63, 0x69, 0xF3, 0x6E, 0x20, 0x64, 0x65, 0x20, 0x70, 0x61, 0x6E, 0x74, 0x61, 0x6C, 0x6C, 0x61, 0x00 };
      ...
      const char *path, const char *label, unsigned type)
{
   ...
   if (!strcmp(label, "Video"))
   {
      ...
      menu_list_push(list, reso_pant, "",
            MENU_SETTINGS_VIDEO_RESOLUTION, 0);
#endif
      menu_list_push(list, "Cambiar imagen", "",
