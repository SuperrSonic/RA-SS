...
const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
     ...
     // DECLARE_META_BIND(2, toggle_fullscreen,     RARCH_FULLSCREEN_TOGGLE_KEY, "Fullscreen toggle"),
      DECLARE_META_BIND(2, exit_emulator,         RARCH_QUIT_KEY, "Quit"),
      DECLARE_META_BIND(2, state_slot_increase,   RARCH_STATE_SLOT_PLUS, "State Slot +"),
      DECLARE_META_BIND(2, state_slot_decrease,   RARCH_STATE_SLOT_MINUS, "State slot -"),
    ...
    //  DECLARE_META_BIND(2, pause_toggle,          RARCH_PAUSE_TOGGLE, "Pause Toggle"),
     // DECLARE_META_BIND(2, frame_advance,         RARCH_FRAMEADVANCE, "Frameadvance"),
      DECLARE_META_BIND(2, reset,                 RARCH_RESET, "Reset"),
    ...
    //  DECLARE_META_BIND(2, enable_hotkey,         RARCH_ENABLE_HOTKEY, "Block hotkeys"),
      DECLARE_META_BIND(2, volume_up,             RARCH_VOLUME_UP, "Volume +"),
      DECLARE_META_BIND(2, volume_down,           RARCH_VOLUME_DOWN, "Volume -"),
    //  DECLARE_META_BIND(2, overlay_next,          RARCH_OVERLAY_NEXT, "Next Overlay"),
     ...
     // DECLARE_META_BIND(2, grab_mouse_toggle,     RARCH_GRAB_MOUSE_TOGGLE, "Grab mouse toggle"),
	  ...
	  DECLARE_META_BIND(1, menu_up,               RARCH_MENU_UP, "Menu Up"),
	  DECLARE_META_BIND(1, menu_down,             RARCH_MENU_DOWN, "Menu Down"),
	  DECLARE_META_BIND(1, menu_left,             RARCH_MENU_LEFT, "Menu Left"),
	  DECLARE_META_BIND(1, menu_right,            RARCH_MENU_RIGHT, "Menu Right"),
	  DECLARE_META_BIND(1, menu_ok,               RARCH_MENU_OK, "Menu OK"),
	  DECLARE_META_BIND(1, menu_cancel,           RARCH_MENU_CANCEL, "Menu Cancel"),
	  DECLARE_META_BIND(1, menu_start,            RARCH_MENU_START, "Menu Default"),
	  DECLARE_META_BIND(1, menu_info,             RARCH_MENU_INFO, "Menu Info"),
#endif
};
